...
class MethodPreferenceKoans {
    ...
    void method_preference_int() {
        assertThat(doStuff(1)).isEqualTo(__);
    }

    @Koan
    void method_preference_integer() {
        assertThat(doStuff(Integer.valueOf(1))).isEqualTo(__);
    }

    @Koan
    void method_preference_long() {
        long l = 1;
        assertThat(doStuff(l)).isEqualTo(__);
    }
    ...
    void method_preference_double() {
        ...
        assertThat(doStuff(d)).isEqualTo(__);
    }

    @Koan
    void method_preference_more() {
        assertThat(doStuff(1, Integer.valueOf(2))).isEqualTo(__);
    }
}
